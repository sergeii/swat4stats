    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gametype', apps.utils.db.fields.EnumField(db_column='gametype_enum', enum_type='gametype_enum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('primary', apps.utils.db.fields.EnumField(db_column='primary_enum', enum_type='equipment_enum')),
                ('primary_legacy', models.SmallIntegerField(db_column='primary', default=0)),
                ('primary_ammo', apps.utils.db.fields.EnumField(db_column='primary_ammo_enum', enum_type='ammo_enum')),
                ('primary_ammo_legacy', models.SmallIntegerField(db_column='primary_ammo', default=0)),
                ('secondary', apps.utils.db.fields.EnumField(db_column='secondary_enum', enum_type='equipment_enum')),
                ('secondary_legacy', models.SmallIntegerField(db_column='secondary', default=0)),
                ('secondary_ammo', apps.utils.db.fields.EnumField(db_column='secondary_ammo_enum', enum_type='ammo_enum')),
                ('secondary_ammo_legacy', models.SmallIntegerField(db_column='secondary_ammo', default=0)),
                ('equip_one', apps.utils.db.fields.EnumField(db_column='equip_one_enum', enum_type='equipment_enum')),
                ('equip_one_legacy', models.SmallIntegerField(db_column='equip_one', default=0)),
                ('equip_two', apps.utils.db.fields.EnumField(db_column='equip_two_enum', enum_type='equipment_enum')),
                ('equip_two_legacy', models.SmallIntegerField(db_column='equip_two', default=0)),
                ('equip_three', apps.utils.db.fields.EnumField(db_column='equip_three_enum', enum_type='equipment_enum')),
                ('equip_three_legacy', models.SmallIntegerField(db_column='equip_three', default=0)),
                ('equip_four', apps.utils.db.fields.EnumField(db_column='equip_four_enum', enum_type='equipment_enum')),
                ('equip_four_legacy', models.SmallIntegerField(db_column='equip_four', default=0)),
                ('equip_five', apps.utils.db.fields.EnumField(db_column='equip_five_enum', enum_type='equipment_enum')),
                ('equip_five_legacy', models.SmallIntegerField(db_column='equip_five', default=0)),
                ('breacher', apps.utils.db.fields.EnumField(db_column='breacher_enum', enum_type='equipment_enum')),
                ('breacher_legacy', models.SmallIntegerField(db_column='breacher', default=0)),
                ('head', apps.utils.db.fields.EnumField(db_column='head_enum', enum_type='equipment_enum')),
                ('head_legacy', models.SmallIntegerField(db_column='head', default=0)),
                ('body', apps.utils.db.fields.EnumField(db_column='body_enum', enum_type='equipment_enum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', apps.utils.db.fields.EnumField(db_column='name_enum', enum_type='objective_enum')),
                ('name_legacy', models.SmallIntegerField(db_column='name')),
                ('status', apps.utils.db.fields.EnumField(db_column='status_enum', enum_type='objective_status_enum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('team', apps.utils.db.fields.EnumField(db_column='team_enum', enum_type='team_enum')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('name', apps.utils.db.fields.EnumField(db_column='name_enum', enum_type='procedure_enum')),
                ('name_legacy', models.SmallIntegerField(db_column='name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(primary_key=True, serialize=False, verbose_name='ID')),
                ('name', apps.utils.db.fields.EnumField(db_column='name_enum', enum_type='equipment_enum')),
                ('name_legacy', models.SmallIntegerField(db_column='name')),
                ('time', models.SmallIntegerField(default=0)),
        ...
        migrations.AddField(
            model_name='player',
            name='loadout',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='tracker.loadout'),
        ),
        migrations.AddField(
