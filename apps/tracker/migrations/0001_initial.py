...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        CreateEnumType(
            "coop_status_enum", ["Not Ready", "Ready", "Healthy", "Injured", "Incapacitated"]
        ),
        CreateEnumType(
            "objective_enum",
            [
                "Rendezvous with Jennings",
                "Avoid civilian injuries",
                "Avoid officer injuries",
                "Avoid officer casualties",
                "Avoid suspect casualties",
                "Avoid injuries to yourself",
                "Debrief before the timer expires",
                "Find and deactivate the bombs",
                "Find and disarm the bombs!",
                "Investigate the laundromat",
                "Neutralize Alice Jenkins",
                "Bring order to chaos",
                "Neutralize Javier Arias",
                "Neutralize Andrew Taronne",
                "Neutralize Anton Georgiev",
                "Neutralize Simon Gowan",
                "Neutralize Lian Niu",
                "Neutralize Alex Jimenez",
                "Neutralize Lawrence Fairfax",
                "Neutralize Kiril Stetchkov",
                "Neutralize Hadeon Koshka",
                "Neutralize Allen Kruse",
                "Neutralize Andrew Norman",
                "Neutralize Jean Trouffant",
                "Neutralize Todor Stetchkov",
                "Rescue Lawrence Adams",
                "Rescue all of the civilians",
                "Rescue Gary Altman",
                "Arrest Louie Baccus",
                "Rescue James Betincourt",
                "Rescue Oscar Bogard",
                "Rescue Warren Rooney",
                "Rescue Hyun-Jun Park",
                "Rescue Willis Fischer",
                "Rescue Melinda Kline",
                "Rescue Lionel Macarthur",
                "Rescue Heidi Rosenstein",
                "Rescue Dr. Theodore Sturgeon",
                "Rescue Kim Dong Yin",
                "Rescue Detective Walsh",
                "Locate Officer Wilkins",
                "Rescue Rita Winston",
        ...
        CreateEnumType(
            ...
            [
                "arrested",
                "arrests",
                "average_arrest_streak",
                "average_death_streak",
                "average_kill_streak",
                "coop_best_time",
                "coop_enemy_arrests",
                "coop_enemy_incaps",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "outcome",
                    apps.utils.db.fields.EnumField(
                        db_column="outcome_enum", enum_type="outcome_enum", null=True
                    ),
                ),
                ...
                (
                    "gametype",
                    apps.utils.db.fields.EnumField(
                        db_column="gametype_enum", enum_type="gametype_enum"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "primary",
                    apps.utils.db.fields.EnumField(
                        db_column="primary_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "primary_ammo",
                    apps.utils.db.fields.EnumField(
                        db_column="primary_ammo_enum", enum_type="ammo_enum"
                    ),
                ),
                (
                    "primary_ammo_legacy",
                    models.SmallIntegerField(db_column="primary_ammo", default=0),
                ),
                (
                    "secondary",
                    apps.utils.db.fields.EnumField(
                        db_column="secondary_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "secondary_ammo",
                    apps.utils.db.fields.EnumField(
                        db_column="secondary_ammo_enum", enum_type="ammo_enum"
                    ),
                ),
                (
                    "secondary_ammo_legacy",
                    models.SmallIntegerField(db_column="secondary_ammo", default=0),
                ),
                (
                    "equip_one",
                    apps.utils.db.fields.EnumField(
                        db_column="equip_one_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "equip_two",
                    apps.utils.db.fields.EnumField(
                        db_column="equip_two_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "equip_three",
                    apps.utils.db.fields.EnumField(
                        db_column="equip_three_enum", enum_type="equipment_enum"
                    ),
                ),
                (
                    "equip_three_legacy",
                    models.SmallIntegerField(db_column="equip_three", default=0),
                ),
                (
                    "equip_four",
                    apps.utils.db.fields.EnumField(
                        db_column="equip_four_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "equip_five",
                    apps.utils.db.fields.EnumField(
                        db_column="equip_five_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "breacher",
                    apps.utils.db.fields.EnumField(
                        db_column="breacher_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "head",
                    apps.utils.db.fields.EnumField(
                        db_column="head_enum", enum_type="equipment_enum"
                    ),
                ),
                ...
                (
                    "body",
                    apps.utils.db.fields.EnumField(
                        db_column="body_enum", enum_type="equipment_enum"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    apps.utils.db.fields.EnumField(
                        db_column="name_enum", enum_type="objective_enum"
                    ),
                ),
                ...
                (
                    "status",
                    apps.utils.db.fields.EnumField(
                        db_column="status_enum", enum_type="objective_status_enum"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "team",
                    apps.utils.db.fields.EnumField(db_column="team_enum", enum_type="team_enum"),
                ),
                ("team_legacy", models.SmallIntegerField(db_column="team")),
                (
                    "coop_status",
                    apps.utils.db.fields.EnumField(
                        db_column="coop_status_enum", enum_type="coop_status_enum", null=True
                    ),
                ),
                (
                    "coop_status_legacy",
                    models.SmallIntegerField(db_column="coop_status", default=0),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "category",
                    apps.utils.db.fields.EnumField(
                        db_column="category_enum", enum_type="stats_category_enum", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    apps.utils.db.fields.EnumField(
                        db_column="name_enum", enum_type="procedure_enum"
                    ),
                ),
                ("name_legacy", models.SmallIntegerField(db_column="name")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "team",
                    apps.utils.db.fields.EnumField(
                        db_column="team_enum", enum_type="team_enum", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "profile",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tracker.profile"
                    ),
                ),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    apps.utils.db.fields.EnumField(
                        db_column="name_enum", enum_type="equipment_enum"
                    ),
                ),
                ("name_legacy", models.SmallIntegerField(db_column="name")),
                ("time", models.SmallIntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "server",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="tracker.server"
                    ),
                ),
            ],
        ),
        migrations.AddIndex(
            model_name="server",
            index=models.Index(
                models.Func(models.F("ip"), function="host"),
                models.F("port"),
        ...
        migrations.AddField(
            ...
            name="loadout",
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.PROTECT, to="tracker.loadout"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="alias",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="tracker.alias"
            ),
        ),
        migrations.AddField(
            model_name="player",
        ...
        migrations.AddField(
            ...
            name="loadout",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="tracker.loadout"
            ),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name="server",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="tracker.server"
            ),
        ),
        migrations.AddField(
            model_name="alias",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                models.F("year"),
                models.F("category_legacy"),
                condition=models.Q(("position__lte", 5)),
            ...
            index=models.Index(
                models.OrderBy(
                    django.db.models.expressions.CombinedExpression(
                        models.F("score_swat"), "+", models.F("score_sus")
                    ),
                    descending=True,
                ),
                name="tracker_game_score_swat_score_sus",
            ),
        ),
        migrations.AddIndex(
            model_name="game",
            index=models.Index(
                models.OrderBy(models.F("date_finished"), descending=True),
