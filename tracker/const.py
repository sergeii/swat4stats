...
# main stats
STATS_SCORE = 0
STATS_TIME = 1  # dont count time played in coop
STATS_GAMES = 2  # same
STATS_WINS = 3  # versus mode wins
STATS_LOSSES = 4  # versus mode losses
STATS_DRAWS = 5  # versus mode draws
# good stats
STATS_KILLS = 6
STATS_ARRESTS = 7
# bad stats
...
# top stats
STATS_TOP_SCORE = 11
STATS_KILL_STREAK = 12
STATS_ARREST_STREAK = 13
STATS_DEATH_STREAK = 14
# mode specific stats
STATS_VIP_ESCAPES = 15
STATS_VIP_CAPTURES = 16
STATS_VIP_RESCUES = 17
STATS_VIP_KILLS_VALID = 18
STATS_VIP_KILLS_INVALID = 19
STATS_VIP_TIMES = 20
STATS_RD_BOMBS_DEFUSED = 21
STATS_SG_ESCAPES = 22
STATS_SG_KILLS = 23
# ratio stats
STATS_SPM = 24
...
STATS_COOP_GAMES = 27     # total number of coop rounds played
STATS_COOP_TIME = 28      # total time spent playing in coop modes
STATS_COOP_WINS = 29      # completed missions
STATS_COOP_LOSSES = 30    # failed missions
STATS_COOP_HOSTAGE_ARRESTS = 31
STATS_COOP_HOSTAGE_HITS = 32
STATS_COOP_HOSTAGE_INCAPS = 33
STATS_COOP_HOSTAGE_KILLS = 34
STATS_COOP_ENEMY_ARRESTS = 35
STATS_COOP_ENEMY_HITS = 36
STATS_COOP_ENEMY_INCAPS = 37
STATS_COOP_ENEMY_KILLS = 38
STATS_COOP_ENEMY_INCAPS_INVALID = 39
STATS_COOP_ENEMY_KILLS_INVALID = 40
STATS_COOP_TOC_REPORTS = 41
STATS_COOP_SCORE = 42
