...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_article', (
        ...
        db.send_create_signal('tracker', ['Article'])


    def backwards(self, orm):
        # Deleting model 'Article'
        db.delete_table('tracker_article')
    ...
    models = {
        'tracker.alias': {
            ...
            'isp': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'related_name': "'+'", 'null': 'True', 'to': "orm['tracker.ISP']"}),
        ...
        'tracker.profile': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'}),
            'game_first': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'related_name': "'+'", 'null': 'True', 'to': "orm['tracker.Game']"}),
            'game_last': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'related_name': "'+'", 'null': 'True', 'to': "orm['tracker.Game']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loadout': ('django.db.models.fields.related.ForeignKey', [], {'on_delete': 'models.SET_NULL', 'null': 'True', 'to': "orm['tracker.Loadout']"}),
