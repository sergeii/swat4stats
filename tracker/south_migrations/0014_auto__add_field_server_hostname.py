...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('tracker_server', 'hostname',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('tracker_server', 'hostname')
    ...
    models = {
        'tracker.alias': {
            ...
            'isp': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.ISP']"}),
        ...
        'tracker.game': {
            ...
            'server': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.Server']"}),
        ...
        'tracker.player': {
            ...
            'loadout': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.Loadout']"}),
            'rd_bombs_defused': ('django.db.models.fields.SmallIntegerField', [], {'default': '0'}),
        ...
        'tracker.profile': {
            ...
            'country': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'}),
            'game_first': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.Game']"}),
            'game_last': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'related_name': "'+'", 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.Game']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'loadout': ('django.db.models.fields.related.ForeignKey', [], {'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['tracker.Loadout']"}),
        ...
        'tracker.server': {
            ...
            'hostname': ('django.db.models.fields.CharField', [], {'blank': 'True', 'max_length': '256', 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ip': ('django.db.models.fields.GenericIPAddressField', [], {'max_length': '39'}),
