...
def test_match_existing_ip_range(whois_mock):
    whois_mock.return_value = {
        "nets": [{"country": "UN", "description": "foo", "cidr": "1.2.3.0/24"}]
    }
    ...
    whois_mock.return_value = {
        "nets": [{"country": "EU", "description": "bar", "cidr": "1.2.3.0/24"}]
    }
    ...
    whois_mock.return_value = {
        "nets": [{"country": "UN", "description": "foo", "cidr": "1.0.0.0/8"}]
    }
...
def test_query_same_org_name(whois_mock):
    whois_mock.return_value = {
        "nets": [{"country": "un", "description": "foo", "cidr": "1.2.0.0/16"}]
    }
    obj1, created = ISP.objects.match_or_create("1.2.3.4")
    assert created

    whois_mock.return_value = {
        "nets": [{"country": "un", "description": "foo", "cidr": "4.3.2.0/24"}]
    }
...
def test_query_same_org_name_different_country(whois_mock):
    ...
    whois_mock.return_value = {
        "nets": [{"country": "eu", "description": "foo", "cidr": "4.3.2.0/24"}]
    }
    obj2, created = ISP.objects.match_or_create("4.3.2.1")
    assert created
...
def test_empty_orgname_is_different_from_another_empty_orgname(whois_mock):
    whois_mock.return_value = {
        "nets": [{"country": "un", "description": None, "cidr": "1.2.0.0/16"}]
    }
    obj1, created = ISP.objects.match_or_create("1.2.3.4")
    assert created
    ...
    whois_mock.return_value = {
        "nets": [{"country": "un", "description": None, "cidr": "4.3.2.0/24"}]
    }
    obj2, created = ISP.objects.match_or_create("4.3.2.1")
    assert created
...
def test_query_empty_country_with_nonempty_orgname(whois_mock):
    whois_mock.return_value = {
        "nets": [{"country": None, "description": "foo", "cidr": "1.2.0.0/16"}]
    }
    obj1, created = ISP.objects.match_or_create("1.2.3.4")
    assert created
    assert obj1.name == "foo"
    ...
    whois_mock.return_value = {
        "nets": [{"country": None, "description": "foo", "cidr": "4.3.2.0/24"}]
    }
    obj2, created = ISP.objects.match_or_create("4.3.2.1")
    assert not created
    assert obj2.name == "foo"
