...
def test_get_articles(db, api_client):
    ...
    plain_article = ArticleFactory(title='New master server patch is out',
    ...
    assert [obj['id'] for obj in response.data] == [markdown_article.pk, html_article.pk, plain_article.pk,
                                                    older_articles[0].pk, older_articles[1].pk]
    ...
    assert plain_article_obj['html'] == 'Download it &lt;a href=&quot;http://example.com/&quot;&gt;here&lt;/a&gt;'
