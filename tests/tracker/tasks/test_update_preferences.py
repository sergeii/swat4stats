...
def test_update_player_preferences(task_mock, django_assert_num_queries):
    ...
    PlayerFactory.create_batch(
        3,
        alias__name="BrokenPlayer",
        alias__profile=broken_profile,
    ...
    PlayerFactory.create_batch(
        3,
        alias__name="Mek",
        alias__profile=new_profile,
        alias__isp__country="nl",
        loadout=new_loadout,
        team="suspects",
    )
    ...
    PlayerFactory.create_batch(
        3,
        alias__name="Konten",
        alias__profile=another_profile,
        alias__isp__country="nl",
        loadout=LoadoutFactory(),
        team="suspects",
    )
