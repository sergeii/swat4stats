...
def jogador(db, abomb, brewer, myt, wm, sef):
    jogador = ProfileFactory(first_seen_at=datetime(2015, 12, 4, tzinfo=UTC),
                             last_seen_at=datetime(2015, 12, 31, tzinfo=UTC))
    # 2014
    p1 = PlayerFactory(alias__profile=jogador,
                       ...
                       arrested=5,
                       score=150)
    WeaponFactory(player=p1, name='9mm SMG',
                  time=10, shots=90, hits=25, kills=5, teamhits=3, teamkills=0)
    WeaponFactory(player=p1, name='Stinger',
                  time=8, shots=8, hits=4, kills=0, teamhits=3, teamkills=0)

    # 2015, vip escort
    p2 = PlayerFactory(alias__profile=jogador,
                       ...
                       death_streak=10,
                       vip_rescues=3)
    WeaponFactory(player=p2, name='.45 SMG',
                  time=50, shots=89, hits=65, kills=13, teamhits=0, teamkills=0)
    WeaponFactory(player=p2, name='Shotgun',
                  time=5, shots=1, hits=4, kills=1, teamhits=0, teamkills=0)
    WeaponFactory(player=p2, name='Stinger',
                  time=35, shots=5, hits=3, kills=1, teamhits=2, teamkills=0)
    WeaponFactory(player=p2, name='Flashbang',
                  time=10, shots=3, hits=0, kills=0, teamhits=3, teamkills=0)
    WeaponFactory(player=p2, name='Taser Stun Gun',
                  time=10, shots=0, hits=0, kills=0, teamhits=0, teamkills=0)

    p3 = PlayerFactory(alias__profile=jogador,
                       ...
                       score=2000,
                       vip_rescues=1)
    WeaponFactory(player=p3, name='9mm Handgun',
                  time=800, shots=24, hits=11, kills=3, teamhits=0, teamkills=0)
    WeaponFactory(player=p3, name='Taser Stun Gun',
                  time=110, shots=24, hits=17, kills=0, teamhits=2, teamkills=0)
    WeaponFactory(player=p3, name='Shotgun',
                  time=0, shots=0, hits=0, kills=0, teamhits=0, teamkills=0)

    p4 = PlayerFactory(alias__profile=jogador,
                       game__date_finished=datetime(2015, 4, 1, tzinfo=UTC),
                       game__gametype='VIP Escort',
                       ...
                       vip_captures=2,
                       vip_kills_invalid=1)
    WeaponFactory(player=p4, name='Stinger',
                  time=100, shots=3, hits=1, kills=0, teamhits=0, teamkills=0)
    WeaponFactory(player=p4, name='Nova Pump',
                  time=75, shots=15, hits=5, kills=0, teamhits=0, teamkills=0)
    WeaponFactory(player=p4, name='9mm Machine Pistol',
                  time=80, shots=90, hits=20, kills=14, teamhits=17, teamkills=0)
    WeaponFactory(player=p4, name='5.56mm Light Machine Gun',
                  time=50, shots=180, hits=90, kills=18, teamhits=9, teamkills=0)
    WeaponFactory(player=p4, name='Shotgun',
                  time=18, shots=5, hits=7, kills=1, teamhits=1, teamkills=1)

    # 2015, coop
    PlayerFactory(alias__profile=jogador,
    ...
    p5 = PlayerFactory(alias__profile=jogador,
                       ...
                       arrest_streak=11,
                       death_streak=6)
    WeaponFactory(player=p5, name='AK-47 Machinegun',
                  time=319, shots=192, hits=50, teamhits=0, kills=18, teamkills=7)
    WeaponFactory(player=p5, name='Taser Stun Gun',
                  time=120, shots=28, hits=10, kills=0, teamhits=9, teamkills=0)
    WeaponFactory(player=p5, name='Shotgun',
                  time=5, shots=1, hits=1, kills=1, teamhits=0, teamkills=0)

    # 2016, vip escort
    p6 = PlayerFactory(alias__profile=jogador,
                       ...
                       arrest_streak=5,
                       death_streak=10)
    WeaponFactory(player=p6, name='AK-47 Machinegun',
                  shots=192, hits=50, teamhits=0, kills=18)
...
def spieler(db, abomb, brewer, wm, myt, sef):
    spieler = ProfileFactory(first_seen_at=datetime(2013, 1, 8, tzinfo=UTC),
                             last_seen_at=datetime(2016, 8, 15, tzinfo=UTC))
    # 2014
    p1 = PlayerFactory(alias__profile=spieler,
                       ...
                       time=38,
                       score=80)
    WeaponFactory(player=p1, name='.45 SMG',
                  time=30, shots=31, hits=10, kills=3, teamhits=9, teamkills=2)
    WeaponFactory(player=p1, name='Flashbang',
                  time=8, shots=8, hits=3, kills=0, teamhits=3, teamkills=0)

    # 2015, vip escort
    p2 = PlayerFactory(alias__profile=spieler,
                       ...
                       arrest_streak=0,
                       death_streak=0)
    WeaponFactory(player=p2, name='9mm SMG',
                  time=180, shots=30, hits=20, kills=2, teamhits=0, teamkills=0)

    # 2015, coop
    PlayerFactory(alias__profile=spieler,
    ...
    # 2015, rd
    p3 = PlayerFactory(alias__profile=spieler,
                       ...
                       time=901,
                       score=10)
    WeaponFactory(player=p3, name='9mm SMG',
                  time=900, shots=7, hits=2, kills=1, teamhits=0, teamkills=0)

    # 2016, vip escort
    p4 = PlayerFactory(alias__profile=spieler,
                       ...
                       arrest_streak=0,
                       death_streak=0)
    WeaponFactory(player=p4, name='9mm SMG',
                  time=80, shots=100, hits=75, kills=8, teamhits=7, teamkills=0)
    WeaponFactory(player=p4, name='Suppressed 9mm SMG',
                  time=80, shots=55, hits=25, kills=5, teamhits=0, teamkills=0)
    WeaponFactory(player=p4, name='Less Lethal Shotgun',
                  time=29, shots=8, hits=1, kills=0, teamhits=5, teamkills=0)
    WeaponFactory(player=p4, name='Taser Stun Gun',
                  time=10, shots=0, hits=0, kills=0, teamhits=0, teamkills=0)

    p5 = PlayerFactory(alias__profile=spieler,
                       game__date_finished=datetime(2016, 5, 13, tzinfo=UTC),
                       game__gametype='VIP Escort',
                       game__outcome='swat_vip_bad_kill',
                       game__map=brewer,
                       ...
                       death_streak=1)
    WeaponFactory(player=p5, name='Taser Stun Gun',
                  time=90, shots=12, hits=12, kills=0, teamhits=0, teamkills=0)
    WeaponFactory(player=p5, name='Suppressed 9mm SMG',
                  time=15, shots=5, hits=1, kills=0, teamhits=0, teamkills=0)

    # 2016, vip, not enough players
    p6 = PlayerFactory(alias__profile=spieler,
                       ...
                       arrest_streak=4,
                       death_streak=3)
    WeaponFactory(player=p6, name='9mm SMG',
                  time=500, shots=120, hits=90, kills=5, teamhits=3, teamkills=0)
    WeaponFactory(player=p6, name='Suppressed 9mm SMG',
                  time=200, shots=55, hits=25, kills=6, teamhits=5, teamkills=1)
    WeaponFactory(player=p6, name='Taser Stun Gun',
                  time=100, shots=20, hits=12, kills=0, teamhits=1, teamkills=0)
    ...
    # 2016, rd
    p7 = PlayerFactory(alias__profile=spieler,
                       ...
                       arrest_streak=1,
                       death_streak=7)
    WeaponFactory(player=p7, name='9mm SMG',
                  time=100, shots=100, hits=75, kills=17, teamhits=3, teamkills=5)
    WeaponFactory(player=p7, name='Less Lethal Shotgun',
                  time=200, shots=18, hits=17, kills=0, teamhits=1, teamkills=0)
    WeaponFactory(player=p7, name='Cobra Stun Gun',
                  time=100, shots=9, hits=6, kills=0, teamhits=3, teamkills=0)
    WeaponFactory(player=p7, name='Taser Stun Gun',
                  time=25, shots=5, hits=1, kills=0, teamhits=0, teamkills=0)

    # 2017
    p8 = PlayerFactory(alias__profile=spieler,
                       ...
                       arrest_streak=0,
                       death_streak=0)
    WeaponFactory(player=p8, name='Suppressed 9mm SMG',
                  time=100, shots=23, hits=11, kills=3, teamhits=1, teamkills=0)
    WeaponFactory(player=p8, name='Less Lethal Shotgun',
                  time=70, shots=45, hits=17, kills=0, teamhits=9, teamkills=0)
    WeaponFactory(player=p8, name='Cobra Stun Gun',
                  time=30, shots=2, hits=1, kills=0, teamhits=0, teamkills=0)
...
def test_update_player_stats(db, settings, spieler, jogador):
    ...
    assert PlayerStats.objects.filter(
        year=2016,
        profile=spieler,
        category__in=['draws', 'grenade_hits', 'grenade_shots']
    ).count() == 0
...
def test_update_player_stats_for_empty_profile(db):
    profile1 = ProfileFactory(first_seen_at=datetime(2015, 12, 4, tzinfo=UTC),
                              last_seen_at=datetime(2015, 12, 31, tzinfo=UTC))
...
def test_update_weapon_stats(db, settings, jogador, spieler):
    ...
    spieler_stats_qs = (WeaponStats.objects
                        .filter(profile=spieler)
                        .order_by('year', 'category', 'weapon')
                        .values('year', 'weapon', 'category', 'points'))
...
def test_update_server_stats(db, settings, spieler, jogador, myt, wm, sef):
    ...
    spieler_stats_qs = (ServerStats.objects
                        .filter(profile=spieler)
                        .order_by('year', 'category', 'server_id')
                        .values('year', 'server_id', 'category', 'points'))
...
def test_update_map_stats(abomb, brewer, spieler, jogador):
    profile = ProfileFactory(first_seen_at=datetime(2015, 12, 4, tzinfo=UTC),
                             last_seen_at=datetime(2015, 12, 31, tzinfo=UTC))
    ...
    PlayerFactory(alias__profile=profile,
                  ...
                  score=150)  # also irrelevant in CO-OP
    PlayerFactory(alias__profile=profile,
...
def test_update_gametype_stats(db, settings, spieler, jogador):
    ...
    spieler_stats_qs = (GametypeStats.objects
                        .filter(profile=spieler)
                        .order_by('year', 'category', 'gametype')
                        .values('year', 'gametype', 'category', 'points'))
