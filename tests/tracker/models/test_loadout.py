...
fields = ['primary', 'primary_ammo', 'secondary', 'secondary_ammo',
...
def test_obtain_loadout():
    ...
    semi_full_loadout = LoadoutFactory(primary='9mm SMG', secondary='Taser Stun Gun', breacher='Shotgun')
    full_loadout = LoadoutFactory(primary='9mm SMG', secondary='Taser Stun Gun',
                                  breacher='Shotgun', head='Gas Mask', body='Light Armor')

    assert Loadout.objects.obtain(primary='9mm SMG', secondary='Taser Stun Gun',
                                  breacher='Shotgun', head='None', body=None) == semi_full_loadout

    assert Loadout.objects.obtain(primary='9mm SMG', secondary='Taser Stun Gun',
                                  breacher='Shotgun', head='Gas Mask', body='Light Armor') == full_loadout
