...
from tests.factories.tracker import ProfileFactory
...
def test_rank_player_stats_qualify():
    ...
    spm2016_1 = PlayerStatsFactory(
        category="spm_ratio", profile=profile1, year=2016, points=5.56, position=2
    )  # wrong
    spm2016_2 = PlayerStatsFactory(
        category="spm_ratio", profile=profile2, year=2016, points=3.3, position=1
    )

    timenow_1 = PlayerStatsFactory(category="time", profile=profile1, year=now.year, points=999)
    timenow_2 = PlayerStatsFactory(
        category="time", profile=profile2, year=now.year, points=10000, position=1
    )

    spmnow_1 = PlayerStatsFactory(
        category="spm_ratio", profile=profile1, year=now.year, points=3.14, position=3
    )
    spmnow_2 = PlayerStatsFactory(
        category="spm_ratio", profile=profile2, year=now.year, points=2.72
    )
    spmnow_3 = PlayerStatsFactory(
        category="spm_ratio", profile=profile3, year=now.year, points=3.33, position=1
    )

    sprnow_1 = PlayerStatsFactory(
        category="spr_ratio", profile=profile1, year=now.year, points=10.8, position=1
    )
    sprnow_2 = PlayerStatsFactory(
        category="spr_ratio", profile=profile2, year=now.year, points=9.1, position=2
    )
...
def test_rank_map_stats_qualify():
    ...
    timevip2016_1 = GametypeStatsFactory(
        category="time", gametype="VIP Escort", profile=profile1, year=2016, points=1900
    )
    timevip2016_2 = GametypeStatsFactory(
        category="time", gametype="VIP Escort", profile=profile2, year=2016, points=2500
    )
    timevip2016_3 = GametypeStatsFactory(
        category="time", gametype="VIP Escort", profile=profile3, year=2016, points=10000
    )

    timerdnow_1 = GametypeStatsFactory(
        category="time", gametype="Rapid Deployment", profile=profile1, year=now.year, points=1900
    )
    timerdnow_2 = GametypeStatsFactory(
        category="time", gametype="Rapid Deployment", profile=profile2, year=now.year, points=2500
    )
    spmrdnow_1 = GametypeStatsFactory(
        category="spm_ratio",
    ...
    spmrdnow_2 = GametypeStatsFactory(
        category="spm_ratio",
        gametype="Rapid Deployment",
        profile=profile2,
        year=now.year,
    ...
    spmrdnow_3 = GametypeStatsFactory(
        category="spm_ratio",
        gametype="Rapid Deployment",
        profile=profile3,
        year=now.year,
    ...
    timevipnow_1 = GametypeStatsFactory(
        category="time", gametype="VIP Escort", profile=profile1, year=now.year, points=900
    )
    timevipnow_2 = GametypeStatsFactory(
        category="time", gametype="VIP Escort", profile=profile2, year=now.year, points=18900
    )
    spmvipnow_1 = GametypeStatsFactory(
        category="spm_ratio",
        gametype="VIP Escort",
        profile=profile1,
        year=now.year,
    ...
    spmvipnow_2 = GametypeStatsFactory(
        category="spm_ratio", gametype="VIP Escort", profile=profile2, year=now.year, points=1.01
    )
    spmvipnow_3 = GametypeStatsFactory(
        category="spm_ratio",
        gametype="VIP Escort",
        profile=profile3,
        year=now.year,
