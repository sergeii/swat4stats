...
def test_fill_last_seen(db, django_assert_num_queries):
    ...
    profile2 = ProfileFactory(
        first_seen_at=None, last_seen_at=None, game_first=game1, game_last=game1
    )
    # no dates, have different first and last game
    profile3 = ProfileFactory(
        first_seen_at=None, last_seen_at=None, game_first=game1, game_last=game2
    )
    ...
    profile5 = ProfileFactory(
        first_seen_at=utc_datetime(2007, 5, 14, 1, 1, 1),
